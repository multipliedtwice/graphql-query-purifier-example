...
export class DepartmentRelationsResolver {
  ...
  async employees(@TypeGraphQL.Root() department: Department, @TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DepartmentEmployeesArgs): Promise<Employee[]> {
